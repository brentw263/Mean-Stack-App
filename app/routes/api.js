...
var xoauth2 = require('xoauth2'); //Import XOAUTH2
...
module.exports = function(router) {
    ...
    var client = nodemailer.createTransport({
       service: 'Gmail',
       auth: {
            type: 'OAuth2', // Create XOAuth2 Generator
                user: 'iamthetruestrepairman@gmail.com', // Email address to send emails from
                clientId: '1032587429281-du4qvophnpogp2tp4t5dlekj99up82oo.apps.googleusercontent.com',
                clientSecret: 'k6mD_ofe4FEQ2fws6bzp4Sc4',
                refreshToken: '1/JbhwUD_qWz2hQH2WHxqoabz4Xd_xU5GuOqoZNjbQkD4',
                accessToken: 'ya29.GltNBEkVbrWuui_UqjWEpcwmt6c_oBWrX_bEC-ZhxQuUdBLHYb5q4GCDn0cyaQdwzKyzjxP8-vvN7exzFzAjH7m1ADfV8R1I1FAwAGoJ-tnEkj_oHiYSxBusoNP8'
                },
            });
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    var email = {
                        ...
                        to: [user.email, 'brentw263@gmail.com'],
